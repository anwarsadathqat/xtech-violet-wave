  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              ...
              <span className="block gradient-text">technology solutions</span>
            </h1>
            <p className="text-lg md:text-xl text-xtech-light-gray mb-8">
        ...
        <div className="absolute -z-10 top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-xtech-purple/30 blur-[120px] opacity-40"></div>
      </section>
      ...
      <section className="py-12 border-y border-white/10">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center md:justify-between items-center gap-8 opacity-50">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="h-8 w-32 bg-white/20 rounded-md"></div>
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mb-6 text-xtech-light-gray">
            ...
            <div className="flex justify-center">
              <div className="w-64 h-64 bg-gradient-to-bl from-xtech-purple to-xtech-blue rounded-3xl"></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-xtech-dark-purple p-8 rounded-lg">
              ...
              <div className="bg-xtech-purple/20 p-8 rounded-lg flex justify-center items-center">
                <div className="grid grid-cols-3 gap-4">
                  <div className="flex justify-center">
                    <div className="h-20 w-20 rounded-full bg-xtech-purple/40 flex items-center justify-center icon-glow">
            ...
            <div className="bg-xtech-dark-purple p-8 rounded-lg">
              ...
              <div className="bg-blue-900/20 p-8 rounded-lg flex justify-center items-center">
                <div className="grid grid-cols-3 gap-4">
                  <div className="flex justify-center">
                    <div className="h-20 w-20 rounded-full bg-blue-900/40 flex items-center justify-center icon-glow">
      ...
      <section className="py-16 relative">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="text-6xl md:text-7xl font-bold mb-16 opacity-10">Our Services</h2>
          </div>
          
          <div className="flex justify-center mb-16">
            <div className="bg-gradient-to-br from-blue-600/30 to-indigo-800/30 p-8 rounded-xl w-full max-w-md border border-blue-500/30">
